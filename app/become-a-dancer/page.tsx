...
export default function BecomeADancer() {
  ...
  if (submitted) return (
    <div style={{ background: '#0D0F1E', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 24, fontFamily: 'sans-serif' }}>
      ...
      <h2 style={{ color: 'white', fontSize: 22, fontWeight: 700, marginBottom: 8, textAlign: 'center' }}>You're on the list!</h2>
      <p style={{ color: '#8890c0', fontSize: 14, textAlign: 'center', maxWidth: 300, marginBottom: 24 }}>We'll review your application and get your profile live soon. Make sure you've signed up for Fansly through our link to be featured!</p>
      <a href={FANSLY_SIGNUP} target="_blank" rel="noopener noreferrer"
        style={{ background: '#FF2D78', color: 'white', padding: '14px 28px', borderRadius: 12, fontSize: 15, fontWeight: 700, textDecoration: 'none', marginBottom: 12 }}>
        💋 Sign up for Fansly
      </a>
  ...
  return (
    <div style={{ background: '#0D0F1E', minHeight: '100vh', color: 'white', fontFamily: 'sans-serif', paddingBottom: 60 }}>
      ...
      {/* Hero */}
      <div style={{ background: 'linear-gradient(180deg, #1a0d2e 0%, #0D0F1E 100%)', padding: '32px 20px 24px', textAlign: 'center', borderBottom: '1px solid #1e2140' }}>
      ...
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <input
            ...
            placeholder="Your Fansly username"
            style={{ width: '100%', background: '#131629', border: '1px solid #1e2140', borderRadius: 10, padding: '12px 14px', color: 'white', fontSize: 14, boxSizing: 'border-box' }}
          />
        </div>
        ...
        <button onClick={handleSubmit} disabled={loading}
          style={{
            width: '100%', background: loading ? '#333' : '#FF2D78', color: 'white',
